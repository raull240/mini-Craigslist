...
echo "<center><h2><font face='Kaushan Script' color='#2D0D4C'>Cultural Events</font></h2>";

$q = "SELECT ID,PostTitle,DATE(TimeStamp) as Date FROM events where category='cultural'";
