...
echo "<center><h2><font face='Kaushan Script' color='#2D0D4C'>Marketing Jobs</font></h2>";


$q = "SELECT ID,PostTitle,DATE(TimeStamp) as Date FROM jobs where JobType='Marketing' ";
