...
echo "<br/><br/><br/><br/><br/>";
echo "<center><h2><font face='Kaushan Script' color='#2D0D4C'>Job Listing</font></h2>";
echo "<br/><br/>";


echo "<form action='search.php' method='POST'>";
$table="sales";
echo "<input type=\"hidden\" name=\"table\" value=\"jobs\">";
...
echo "<option value='show_jobs_latest.php'>Latest</option>";
echo "</select>";
echo"</td></tr>";

$q = "SELECT ID ,PostTitle ,DATE(TimeStamp) as Date  FROM jobs order by timestamp";
