...
echo "<center><h2><font face='Kaushan Script' color='#2D0D4C'>Real Estate (Office Spaces)</font></h2>";
$q = "SELECT ID,PostTitle,DATE(TimeStamp) as Date FROM realestate where category='commercial'";
