...
//$uid=$_SESSION["UID"];
echo "<center><h2><font face='Kaushan Script' color='#2D0D4C'>Accessories</font></h2>";


$q = "SELECT ID,PostTitle,DATE(TimeStamp) as Date FROM sales where category='accessories'";
